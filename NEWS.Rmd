...
* Increased the performance of the function 'prepareInputToAllocation_beat.1st'

* Added the function 'build_dummy_variables', to derive dummy variables from the target variables: it is useful when it is necessary to differentiate the precision constraints in the different domains of interest
